...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is B_Middleware
                   DESC

  s.homepage     = "https://github.com/moduleDemo/B_middleware"
  ...
  s.source       = { :git => "https://github.com/moduleDemo/B_middleware.git", :tag => s.version.to_s }
  ...
  s.source_files  = "B_Middleware/B_Middleware/**/*.{h,m}"
